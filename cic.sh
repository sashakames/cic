...
nohup python3 cic.py --output-dir $destpath/ --cmor-tables $cmorpath --email e.witham@columbia.edu ames4@llnl.gov --fix-errors --enable-ac > $destpath/cic.$thedate.log
